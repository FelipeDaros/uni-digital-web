      ...
      <Container maxWidth="md">
        <Grid container direction="column">
          <Grid item xs={12} sm={6} md={4}>
            <Typography gutterBottom fontSize={22} sx={{ marginTop: 3, textAlign: 'center', color: 'GrayText' }}>
              Olá, <strong>Felipe</strong>
            </Typography>
          </Grid>
          <Grid item xs={12} sm={3} marginTop={1}>
            <Typography fontSize={14} sx={{ marginTop: 3, textAlign: 'center', color: 'GrayText' }}>
              Sua assinatura UniDigital foi concluída! 💚
            </Typography>
          </Grid>
          <Grid item xs={12} sm={3} marginTop={1}>
            <Typography fontSize={14} sx={{ marginTop: 3, textAlign: 'center', color: 'GrayText' }}>
              Estamos felizes por ter você aqui! Esperamos te oferecer a melhor experiência de saúde.
            </Typography>
          </Grid>
          <Stack
            sx={{ p: 4 }}
          ...
          <Stack
            ...
            spacing={4}
          >
            <CardFeedBack icon={MonitorHeartIcon} title="Clique aqui para agendar consultas de telemedicina" />
            <CardFeedBack icon={ApartmentSharpIcon} title="Conheça nossa red credenciada" />
            <CardFeedBack icon={HailSharpIcon} title="Clique aqui para agendar consultas com médicos especialistas" />
          </Stack>
          <Typography gutterBottom fontSize={16} sx={{ marginTop: 3, textAlign: 'center', color: 'GrayText' }}>
            Se tiver qualquer dúvida ou precisar de informações, fale com a gente:
          </Typography>
          <Stack
            sx={{ p: 4 }}
            direction="row"
            ...
            spacing={4}
          >
            <MiniCardFeedBack icon={PermPhoneMsgSharpIcon} title="(48) 3431-5965" />
