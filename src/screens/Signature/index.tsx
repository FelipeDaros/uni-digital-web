...
const signaturePlans: SignatureProps[] = [
  {
    id: 1,
    description:
      "Assinatura individual: Todos os beneficios do UniDigital para um titular",
    price: 100.25,
    title: "Plano Básico",
  },
  {
    id: 2,
    description:
      "Assinatura duplo: Todos os benefícios do UniDigital para um titular e um dependente",
    price: 450.2,
    ...
    <Grid>
      ...
      <Grid container display="flex" justifyContent="center">
        {signaturePlans.map((item) => (
          <SubscriptionCard
            key={item.id}
            icon="UNIDIGITAL_DUPLO"
            handleSelected={() => handleSelectedSignature(item.id)}
            signture={item}
            isSelected={false}
          />
        ))}
      ...
      {signature.id && (
        <Grid>
          ...
          <Form ref={formRef} onSubmit={(dados) => handleSave(dados)}>
            ...
            >
              O titular é a pessoa responsável pelo aceite do contrato e pelo
              pagamento das mensalidades da Telemedicina Unimed.
            </Typography>
            <Avatar
              sx={{ width: 62, height: 62, marginTop: 6 }}
              alt="Remy Sharp"
              src={avatarFile ?? ""}
            />
            <CustomButton
            ...
            <Typography gutterBottom fontWeight="bold" sx={{ marginTop: 6 }}>
              Contatos
            </Typography>
            <Grid container spacing={3}>
              <Grid item xs={12} sm={6} marginTop={2}>
            ...
            <Typography fontWeight="bold" sx={{ marginTop: 6 }}>
              Endereço
            </Typography>
            <Grid container spacing={3}>
              <Grid item xs={12} sm={6} marginTop={2}>
            ...
            <Typography gutterBottom sx={{ marginTop: 6 }}>
              ...
              fins descritos na nossa Política de Privacidade.
            </Typography>
            <Grid
              container
              direction="row"
              sx={{ alignItems: "center", marginTop: 6 }}
            >
              <Grid item xs={2} sm={1}>
                <Checkbox
                  id="acceptTerms"
              ...
              <Grid item xs={10} sm={8}>
                <Typography>
                  Aceito os termos contidos em contrato. Download do contrato
                  (PDF)
                </Typography>
              </Grid>
            </Grid>
