import { CircularProgress, CssBaseline, LinearProgress, Typography } from '@mui/material';
...
export function SendForgout() {
  ...
  return (
    <StyledContainer>
      ...
      <Image src={logo} />
      <ContainerBox>
        <Typography fontWeight="bold" color="GrayText" fontSize={14} textAlign="center">
          Um e-mail foi enviado para u***********@*******.com o link para que você mude a sua senha.
        </Typography>
        <Typography fontWeight="bold" color="GrayText" fontSize={14} textAlign="center">
